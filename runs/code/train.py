...
# clock. Karpathy's charged training clock below remains unchanged.
...
# OPHIS protocol adapter: upstream hard-codes 42.  Keep 42 for an ordinary
# standalone `uv run train.py`, while making campaign and confirmation seeds an
# executable, emitted contract rather than a replicate label.
try:
...
# OPHIS protocol adapter: retain Karpathy's human-readable summary above, then
# add the single machine-readable endpoint consumed by immutable evidence-v3.
print(
